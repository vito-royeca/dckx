...
struct SearchNavigation<Content: View>: UIViewControllerRepresentable {
    ...
    func makeCoordinator() -> Coordinator {
        Coordinator(content: content(), query: $query, scopeSelection: $scopeSelection, delegate: delegate)
    }
    ...
    class Coordinator: NSObject, UISearchBarDelegate {
        ...
        init(content: Content, query: Binding<String?>, scopeSelection: Binding<Int>, delegate: SearchNavigationDelegate?) {
